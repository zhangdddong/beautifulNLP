...
if __name__ == '__main__':
    ...
    while True:
        ...
        paths = []
        for logits, text_len in zip(logits, text_lens):
            viterbi_path, _ = tfa.text.viterbi_decode(logits[:text_len], model.transition_params)
            paths.append(viterbi_path)
        print(paths[0])
        print([id_to_tag[i] for i in paths[0]])
